<div class='d-flex align-items-center' style="padding: 10px 16px; gap: 0;">
    ...
    <div class="ms-auto d-flex align-items-center gap-3" style="font-size: 0.82rem;">
        ...
        <a href='{{route("weakness")}}' style="color: #8892a4; text-decoration: none; transition: color 0.2s;" onmouseover="this.style.color='#ef4444'" onmouseout="this.style.color='#8892a4'"><i class="bi bi-person-lines-fill" style="margin-right: 3px;"></i>キャラ詳細</a>
